...
public class StandardFunctionalTest {
    void main(){
        ...
        Function<String, Integer> convert = num -> Integer.parseInt(num);
        ...
        // 메소드 참조를 이용해서 String 을 입력받아서 글자수를 반환하는 함수를 작성하세요.
