...
public class TimeTest {
    public static void main(String[] args) {
        ...
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy-MM-dd(E) HH:mm:ss a")));

        // 5. 부트캠프 시작일 2026-05-14일
        // 수료일은 2026-11-16일
        // 오늘은 부트캠프 시작일로부터 몇일 지났는지 출력
        // 앞으로 몇일이 지나면 수료를 하는지 출력
        // 총 수업 기간은 몇일인지 출력하세요.
